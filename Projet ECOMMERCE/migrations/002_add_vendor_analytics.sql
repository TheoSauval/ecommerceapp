-- MIGRATION POUR LES ANALYSES VENDEUR
-- Version: 2
-- Date: [Date du jour]

-- =====================================================
-- FONCTIONS POUR LES ANALYSES VENDEUR
-- =====================================================

-- Fonction pour calculer les revenus totaux d'un vendeur
...
-- Fonction pour obtenir les top-produits d'un vendeur
...
-- Index pour optimiser les requêtes de revenus par vendeur
CREATE INDEX IF NOT EXISTS idx_payments_status_date ON public.payments(status, date_paiement);
CREATE INDEX IF NOT EXISTS idx_orders_status_created ON public.orders(status, created_at);
CREATE INDEX IF NOT EXISTS idx_products_vendor_active ON public.products(vendeur_id, actif);

-- =====================================================
-- VUES POUR FACILITER L'ACCÈS AUX DONNÉES
-- =====================================================

-- Vue pour les revenus par vendeur (mise à jour automatiquement)
...
-- Message de fin
\echo "Migration pour les analyses vendeur appliquée avec succès." 