-- Script de correction pour la table history - Version Simple
...
-- 2. Créer la table history de manière simple
...
-- 6. Fonction simple pour ajouter une consultation
...
AS $$
BEGIN
    -- Insérer directement (pas de contrainte unique)
...
SELECT 'Table history créée avec succès - Version Simple' as status; 